...
44. Every §14 command obeys one deterministic §14.14 runtime contract:
    ...
    - The operable inspection surface is exactly `db status`, `logs list`, `facts list/show`, `gaps list`, `contradictions list/show`, `assess list/show`, `jd list`, and `runs list/show`; evidence-item, branch/bullet, per-job-description, deeper historical-generation, and parsed-requirement-dump inspection remains explicitly deferred.
