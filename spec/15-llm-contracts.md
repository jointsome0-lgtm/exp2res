...
- The literal `{}` candidate in §15.5 and the empty arrays in §15.7 are schema-envelope notation for the complete typed candidates, never empty transport values; those examples demonstrate response shape rather than a reproducible verdict from hidden candidate content.
