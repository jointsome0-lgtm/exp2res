...
On success, `export resume` publishes the selected current branch only at its §13.14 ID-keyed path and returns only the manifest-validated §14.14 export result.
