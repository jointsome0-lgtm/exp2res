...
- **Phase 2 — Gaps and Contradictions**
  ...
  - Definition of done:
    ...
    - Corrections append linked records and rebuild the current Stage 3–4 state (view reporting extends the flow when Phase 3 lands).
...
- **Phase 3 — Assessment**
  - Pipeline stages (§13): Stages 6–7 + assessment export (Stage 12) + the §14.17 global view-serving slice.
  - Definition of done:
