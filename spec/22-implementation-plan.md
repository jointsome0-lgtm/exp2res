...
| 2 — Gaps and Contradictions | Stage 4 + correction/recompute flow (§5.3, §13.13, §14.4/§14.12) | Weak facts generate useful questions; contradictions are immutable complete-generation detections, not hidden or transitioned in place; corrections append linked records and rebuild the current Stage 3–5 state while reporting invalidated views and branches for explicit regeneration (§13.13). |
