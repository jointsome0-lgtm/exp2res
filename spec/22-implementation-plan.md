...
| 2 — Gaps and Contradictions | Stage 4 + correction/recompute flow (§5.3, §13.13, §14.4/§14.12) | Weak facts generate useful questions; contradictions are stored, not hidden; corrections append linked records and rebuild current derived state. |
...
| 4 — Resume Export | Stages 8 and 10–12 | System generates a job-targeted Markdown resume with evidence map and verification report; unsupported or superseded bullets are blocked and lifecycle changes invalidate managed exports. |
