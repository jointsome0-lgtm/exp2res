...
| §15.5 assessment verifier | A candidate self-claim with its snapshot's scope and target, the view's complete current signal set, and its exact §15.5 provenance closure: source signals, closure facts, their linked evidence items, and the retained raw logs reached through them — including raw personal text and burnout-grade text present in those logs. |
