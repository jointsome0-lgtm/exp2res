...
- [`exp2res/`](exp2res/) — the implemented Python package, currently covering workspace management, manual capture, owner deletion and purge, the isolated Codex and Claude runner substrates, Stages 3–7 from fact extraction through verification with the correction/recompute flow, assessment export, and raw-log/fact/gap/contradiction inspection.
