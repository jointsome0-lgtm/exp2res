...
- [`exp2res/`](exp2res/) — the implemented Python package, currently covering the Phase 0 workspace, manual capture, inspection, and owner-deletion slice.
- [`tests/`](tests/) — offline tests for the implemented Phase 0 behavior.
...
The repository now contains runnable Phase 0 code. The [ecosystem-wide security policy](https://github.com/jointsome0-lgtm/selfos/blob/main/SECURITY.md) governs vulnerability reporting, while [spec §29](spec/29-security-and-privacy.md) remains the canonical Exp2Res security, privacy, and managed-data boundary.
