...
- §13 Pipeline Specification — the ten active stable-number stages, raw capture and correction displacement through extraction, detection, assessment, verification, JD parsing, and export; §13.13 recompute lifecycle, §13.14 managed-output writer
