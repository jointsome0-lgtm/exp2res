...
ASSESSMENT_VERIFIER_INSTRUCTIONS = (
    ...
    "upgrade beyond linked evidence. An open-ended placement supports only activity from "
    ...
    "currently, to date, or still ongoing today. Never frame independent projects, competitions, "
    ...
    "person (you, your) and subject-free phrasing that names no subject. Candidate prose "
    "that addresses the owner as you is the mandated mirror voice — never quote it as an "
    "unsupported phrase, never ground counterevidence on it, and never lower a status for "
    "it. The violation is the other grammatical person: a claim whose prose refers to the "
