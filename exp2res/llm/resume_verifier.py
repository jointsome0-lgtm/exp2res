...
RESUME_VERIFIER_INSTRUCTIONS = (
    ...
    "in the bullet's text. Check job relevance against the supplied parsed "
    ...
    "evidence supports only unknown. Metrics must occur in the supplied source "
    "logs, imported artifacts, or gap answers; a number the sources do not carry "
    "is invented. Production, customer, scale, revenue, and reliability language "
    "requires explicit support. "
    "Normalize temporal expressions to OccurredAt and compare both placement and "
    "precision. Entailment runs from the evidence to the bullet: a placement whose "
