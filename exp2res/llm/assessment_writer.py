...
ASSESSMENT_WRITER_INSTRUCTIONS = (
    ...
    "other claims without adding a fact. Choose each claim's dimension by what the "
    ...
    "key on this dimension. Use pattern_signal only for a claim summarizing a "
    "recurring supported pattern and hypothesis for a bounded tentative "
    "interpretation; a signal-derived claim asserting a capability still carries a "
    "capability dimension. Never emit a claim that merely restates a supplied "
