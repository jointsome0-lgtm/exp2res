...
FACT_EXTRACTOR_INSTRUCTIONS = (
    ...
    "date, production use, or employment framing only as a supplied record states it, "
    "and never invent one the records do not carry. The fact you emit is your own voice, "
