...
FACT_EXTRACTOR_INSTRUCTIONS = (
    ...
    "off-topic for every fact you emit. Set ownership_level to the strongest level the "
    "supplied content explicitly supports, and to unknown when no supplied content "
    "establishes ownership; never upgrade beyond that level. Record a metric, outcome, "
