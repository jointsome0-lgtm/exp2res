...
FACT_EXTRACTOR_INSTRUCTIONS = (
    ...
    "off-topic for every fact you emit. Set each fact's ownership_level to the strongest "
    "level the evidence that fact selects explicitly supports, and to unknown when none "
    "of that selected evidence establishes ownership; a stronger role stated by any "
    "record the fact does not select never raises it. Record a metric, outcome, "
