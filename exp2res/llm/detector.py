...
DETECTOR_INSTRUCTIONS = (
    ...
    "dates, or permanent identity: restate such a value only as an object that "
    "candidate itself targets or references states it — a value carried by an "
    "unrelated supplied object supports nothing — and never render an independent "
    "project, a competition, or learning as employment. Keep any pattern you describe "
    "bounded to what current evidence suggests or a recurring pattern appears, never a "
    "permanent trait such as you are fundamentally or you will always. "
    "Each question must have exactly one typed current "
