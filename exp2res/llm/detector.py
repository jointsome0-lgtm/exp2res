...
DETECTOR_INSTRUCTIONS = (
    ...
    "dates, or permanent identity: restate such a value only as a supplied object "
    "states it, and keep any pattern you describe bounded to what current evidence "
    "suggests or a recurring pattern appears, never a permanent trait such as you are "
    "fundamentally or you will always. Each question must have exactly one typed current "
